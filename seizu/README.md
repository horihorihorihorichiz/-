...
| `kodomo.html` | 小学生でもわかる 答案の描き方（線と記号のいみ・描く順番） |
...
- 柱は全階共通16本（通し柱120角×4＝四隅、管柱120角×12）
- 階段は3階とも西側の同じ位置。**1階→2階は15段（蹴上206.7）、2階→3階は14段（蹴上207.1）**、踏面はいずれも227.5（910÷4）
- **1FL = GL+550**（基礎の立上りを地上300mm以上とるため）。軒高 9,350、最高 10,806
- 外壁 178mm＝強化石膏ボード15＋柱120（GW100）＋構造用合板9＋透湿防水シート＋通気胴縁18＋窯業系サイディング16
