...
for i, (span, sei) in enumerate(((1820, 180), (2730, 240), (3640, 300))):
...
beam(190, 424, 1820, 180, '柱が乗らない → 180', col=WOOD)
beam(460, 424, 1820, 210, '柱が乗る → 210', top_post=True, col='#e8b98c')
