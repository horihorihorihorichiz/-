...
ZUSHO_NOKISAKI = (
    '⑹ 部分詳細図（断面）<br>（１/20）',
    'ア．切断位置は、軒先及び外壁を含む部分とする。<br>'
    'イ．作図の範囲は、３階屋根部分（「軒桁上端から上方600mm以上」及び'
    '「３階天井仕上面より下方500mm以上」を含む部分）とし、外壁の柱心から'
    '1,000mm以上とする。<br>'
    'ウ．屋根の勾配を記入する。<br>'
    'エ．主要部の寸法等を記入する。<br>'
    'オ．主要部材（軒桁、小屋梁、母屋、垂木など必要なもの）の名称・'
    '断面寸法を記入する。<br>'
    'カ．羽子板ボルト等の金物の名称・寸法を記入する。<br>'
    'キ．屋根（小屋裏が外気に通じている場合は、屋根の直下の天井）、外壁、'
    'その他必要と思われる部分の断熱・防湿措置を記入する。<br>'
    'ク．主要な部位（屋根、外壁、内壁及び３階天井）の仕上材料名を記入する。'
    '<br>ケ．外壁の仕上げについては、乾式工法によるものとする。')
...
ZUSHO = [
    ('⑴ １階平面図兼配置図<br>（１/100）<br><br>⑵ ２階平面図<br>（１/100）'
     ...
     '<li>玄関の土間部分及びポーチの地盤面からの高さ</li>'
     '<li>玄関ホール（廊下）及び店舗売場の床高</li>'
    ...
    ('⑸ 立面図<br>（１/100）',
     'ア．<b>道路側</b>の立面図とする。<br>'
     'イ．建築物の最高の高さを記入する。<br>'
     '※ 本番は「南側立面図とする」のように面を名ざしで指定される。'
     '<b>指定された面以外を描くと重大な不適合</b>になる。'),
    ('⑹ 部分詳細図（断面）<br>（１/20）',
...
Y_KOZO = ('木造３階建てとするに当たり、構造計画上工夫した点',
          ...
          'いずれにも偏りなく配置した。１階の柱は令43条2項ただし書に'
          '基づき、土台及び横架材と金物で緊結し、構造計算により安全を'
          '確かめている。木造３階建ては上階からの鉛直力及び水平力が'
          '大きくなるため、力の流れを上下階でそろえる必要があるから'
          'である。これにより直下率が高くなり、地震力及び風圧力を'
          '剛床を介して耐力壁へ確実に伝達させることができる。')
...
SPECS = [
 dict(tag='A', name='南側道路（本命）',
      ...
      figs=[('⑴ １階平面図兼配置図（1/100）', 'ansA_1f'),
            ('⑵ ２階平面図（1/100）', 'plan2f'),
            ('⑶ ３階平面図（1/100）', 'plan3f'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その1　3階床伏図', 'ansfuse_floor'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その2　小屋伏図', 'ansfuse_roof'),
            ('⑸ 南側立面図（1/100）', 'ansAelev'),
 ...
 dict(tag='B', name='１階に母の寝室',
      ...
      figs=[('⑴ １階平面図兼配置図（1/100）', 'ansB_1f'),
            ('⑵ ２階平面図（1/100）', 'ansB_2f'),
            ('⑶ ３階平面図（1/100）', 'ansB_3f'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その1　3階床伏図', 'ansBfuse_floor'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その2　小屋伏図', 'ansBfuse_roof'),
            ('⑸ 南側立面図（1/100）', 'ansBelev'),
            ('⑹ 部分詳細図（断面）（1/20）', 'detail')]),
 ...
 dict(tag='C', name='間口の狭い敷地',
      ...
      figs=[('⑴ １階平面図兼配置図（1/100）', 'ansC_1f'),
            ('⑵ ２階平面図（1/100）', 'ansC_2f'),
            ('⑶ ３階平面図（1/100）', 'ansC_3f'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その1　3階床伏図', 'ansCfuse_floor'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その2　小屋伏図', 'ansCfuse_roof'),
            ('⑸ 南側立面図（1/100）', 'ansCelev'),
            ('⑹ 部分詳細図（断面）（1/20）', 'detail')]),

 dict(tag='D', name='東側道路', detail='nokisaki',
      lead='ある地方都市の商店街において、パン屋を営む夫婦とその子ども'
           '２人が住むための併用住宅を計画する。',
      ...
      youten=[
        ...
        ('階段の位置と直下率について工夫した点',
         ...
         '通り芯の交点と窓・出入口の両わきに各階共通で配置し、'
         '柱と柱の間隔は1,820mm以下として直下率を高めた。'
         '梁の最大スパンは3,640mmに抑えている。'),
        Y_DOUSEN],
      figs=[('⑴ １階平面図兼配置図（1/100）', 'ansD_1f'),
            ('⑵ ２階平面図（1/100）', 'ansD_2f'),
            ('⑶ ３階平面図（1/100）', 'ansD_3f'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その1　3階床伏図', 'ansDfuse_floor'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その2　小屋伏図', 'ansDfuse_roof'),
            ('⑸ 東側立面図（1/100）', 'ansDelev')]),
 ...
 dict(tag='E', name='南東の角地',
      ...
      youten=[
        ...
        ('容積率及び建蔽率の算定について',
         ...
         '建蔽率の限度は、特定行政庁が指定した角地の加算10%に、準防火'
         '地域内の準耐火建築物の加算10%（法53条3項一号ロ）を合わせて'
         '100% となるが、本計画は36.4% であり大きく余裕がある。'),
        y_bouka('198.72')],
      figs=[('⑴ １階平面図兼配置図（1/100）', 'ansE_1f'),
            ('⑵ ２階平面図（1/100）', 'ansE_2f'),
            ('⑶ ３階平面図（1/100）', 'ansE_3f'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その1　3階床伏図', 'ansEfuse_floor'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その2　小屋伏図', 'ansEfuse_roof'),
            ('⑸ 南側立面図（1/100）', 'ansEelev'),
            ('⑹ 部分詳細図（断面）（1/20）', 'detail')]),
 ...
 dict(tag='F', name='北側道路',
      ...
      figs=[('⑴ １階平面図兼配置図（1/100）', 'ansF_1f'),
            ('⑵ ２階平面図（1/100）', 'ansF_2f'),
            ('⑶ ３階平面図（1/100）', 'ansF_3f'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その1　3階床伏図', 'ansFfuse_floor'),
            ('⑷ 床伏図兼小屋伏図（1/100）　その2　小屋伏図', 'ansFfuse_roof'),
            ('⑸ 北側立面図（1/100）', 'ansFelev'),
            ('⑹ 部分詳細図（断面）（1/20）', 'detail')]),
]
...
def mondai(sp):
    ...
    for nm, memo in ZUSHO:
        if nm.startswith('⑹') and sp.get('detail') == 'nokisaki':
            nm, memo = ZUSHO_NOKISAKI
...
def kaitou(sp):
    ...
    if sp['tag'] != 'A':
        o.append('<div class="warn">床伏図兼小屋伏図・立面図・部分詳細図の'
                 '<b>考え方</b>は予想問題Ａと同じです。'
                 'この解答例では、建築物の大きさ・通りの位置に合わせて'
                 '梁のスパンが3,640mmを超えないように組み直してあります。'
                 '部分詳細図（外壁の断面）は建物の大きさに関係なく同じなので、'
                 'Ａと同じ図を載せています。</div>')
    for title, fig in sp['figs']:
        o.append('<h2 class="sec brk">%s</h2>' % title)
        o.append('<div class="fig">%s</div>' % inline_svg(fig))

    if sp.get('detail') == 'nokisaki':
        o.append('<h2 class="sec brk">⑹ 部分詳細図（断面）（1/20）'
                 '　軒先まわり</h2>')
        o.append('<div class="warn">この問題だけ、部分詳細図は'
                 '<b>軒先まわり</b>を要求しています。'
                 '基礎・土台ではなく、軒桁・垂木・'
                 '母屋・屋根の層を描きます。切断位置は１階平面図ではなく'
                 '<b>３階平面図</b>の外壁に打ちます。</div>')
        o.append('<div class="fig">%s</div>' % inline_svg('dh_nokisaki'))
    o.append('</div>')
    return ''.join(o)
