# -*- coding: utf-8 -*-
"""伏図の「表示記号」の一覧。公式の標準解答例（令和7年）の凡例欄どおり。

柱の記号と120角は令和4〜7年で同じ。火打梁・棟木・母屋の寸法は年で変わる
（令和7年 90・120・90、令和5年 105・105・105）。"""
import os
...
row(8, '棟木・小屋束', '120×120', d_munagi, '2本線＋黒丸（小屋束）。寸法欄に書くのは棟木の分だけ')
row(9, '母屋・小屋束', '90×90', d_moya, '一点鎖線＋黒丸（小屋束）。寸法欄に書くのは母屋の分だけ')
