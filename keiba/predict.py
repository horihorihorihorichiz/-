...
# 288R trainの実測(7/12): モデルの付加価値は3着内の並び(α_place)にのみ存在
# → place系(複勝/ワイド/三連複)だけ買う。勝ち順系(馬連/馬単/三連単)は
#   α=0(勝者予測でモデル情報なし)+train 0/32的中で理論・実測とも死に票=無効化。
EDGE_MIN = {"単勝": 1.30, "複勝": 1.15, "ワイド": 1.40, "三連複": 2.10,
            "馬連": 99.0, "馬単": 99.0, "三連単": 99.0}
