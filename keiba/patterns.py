...
# ★2026-08-22 ユーザー指示で階級額を全面改定: A=5000 / S=10000 / SS=20000。
#   (指示「Aが5000円でいこ」「sは1万ssは2万」)
#   注意: 7/27 sim_rank.py の階級設計は A=2000/S=5000/SS=10000 を前提に全階級黒字・
#   最大DD-8.1万を確認したもの。今回の改定で **1レースあたりの投下額が全階級2倍**になり、
#   ドローダウンも単純に2倍になる(最大DD想定 -8.1万 → -16.2万)。
#   さらにSS/Sの根拠ROIは「採掘窓内の参考値」であり凍結後(2026-08-16〜)の実測はまだ薄い。
#   実弾で使う場合はこの2点を承知の上で。紙上運用は影響なし(掛け金ゼロ)。
TIER_BUDGET = {"SS": 20000, "S": 10000, "A": 5000, "B": 1000, "C": 0}
