...
# ★2026-08-22 ユーザー指示「Aが5000円でいこ」でA階級を2000→5000円に変更。
#   注意: 7/27 sim_rank.py の階級設計は A=2000円 を前提に全階級黒字を確認したもの。
#   A を5000円にすると A の損益寄与が2.5倍になり、A帯(ROI160%+)が実測で下振れした場合の
#   ドローダウンも2.5倍になる。実弾で使う場合はこの点を承知の上で。
TIER_BUDGET = {"SS": 10000, "S": 5000, "A": 5000, "B": 1000, "C": 0}
